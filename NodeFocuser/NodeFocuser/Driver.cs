...
//
// ASCOM Focuser driver for NodeFocuser
//
...
{
    //
    // Your driver's DeviceID is ASCOM.NodeFocuser.Focuser
    //
    // The Guid attribute sets the CLSID for ASCOM.NodeFocuser.Focuser
    // The ClassInterface/None addribute prevents an empty interface called
    // _NodeFocuser from being created and used as the [default] interface
    //
    ...
    /// ASCOM Focuser Driver for NodeFocuser.
    /// </summary>
    [Guid("d2b1a9a1-79af-4ac5-8b64-632c4b5fc589")]
    ...
    public class Focuser : IFocuserV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.NodeFocuser.Focuser";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NodeFocuser"/> class.
        /// Must be public for COM registration.
        /// </summary>
        public Focuser()
        {
            tl = new TraceLogger("", "NodeFocuser");
